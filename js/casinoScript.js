...
if (wWidth >= 480) {
	...
	imgDiv.setAttribute('style', ' padding: 0; align-content: space-around; width: 340px; flex-wrap: wrap; justify-content: space-around;  display: flex; margin: 0 auto; height:335px; background: url(../img/imageCasino/gameMachine.jpg) no-repeat center;');
	...
	imgDiv.setAttribute('style', ' display: flex; align-content: space-around ;width: 700px; flex-wrap: wrap; justify-content: space-around;  margin: 0 auto; height: 700px; background: url(../img/imageCasino/gameMachineSmall.jpg) no-repeat center;');
...
let section = document.querySelector('#aCasino');
section.setAttribute('style', 'color: violet; font-weight: 600;');
r1c1.setAttribute('alt', 'Комірка1');
r1c2.setAttribute('alt', 'Комірка2');
r1c3.setAttribute('alt', 'Комірка3');
r2c1.setAttribute('alt', 'Комірка4');
r2c2.setAttribute('alt', 'Комірка5');
r2c3.setAttribute('alt', 'Комірка6');
r3c1.setAttribute('alt', 'Комірка7');
r3c2.setAttribute('alt', 'Комірка8');
r3c3.setAttribute('alt', 'Комірка9');
...
function NewGame(){
	...
	countAttempt=0;
	flag=false;
	r1c1.setAttribute ('src','../img/imageCasino/zero.png');
	r1c2.setAttribute ('src','../img/imageCasino/zero.png');
	r1c3.setAttribute ('src','../img/imageCasino/zero.png');
	r2c1.setAttribute ('src','../img/imageCasino/zero.png');
	r2c2.setAttribute ('src','../img/imageCasino/zero.png');
	r2c3.setAttribute ('src','../img/imageCasino/zero.png');
	r3c1.setAttribute ('src','../img/imageCasino/zero.png');
	r3c2.setAttribute ('src','../img/imageCasino/zero.png');
	r3c3.setAttribute ('src','../img/imageCasino/zero.png');
}
function Wheel( fruitImg, i){
	if(i==0){
		lastFruit= fruitNow;
		if(fruitImg==0){
			r1c1.setAttribute ('src','../img/imageCasino/apple.jpg');
			r2c1.setAttribute ('src','../img/imageCasino/lemon.jpg');
			r3c1.setAttribute ('src','../img/imageCasino/pear.jpg');
		}
		if(fruitImg==1){
			r1c1.setAttribute ('src','../img/imageCasino/pear.jpg');
			r2c1.setAttribute ('src','../img/imageCasino/apple.jpg');
			r3c1.setAttribute ('src','../img/imageCasino/lemon.jpg');
		}
		if(fruitImg==2){
			r1c1.setAttribute ('src','../img/imageCasino/lemon.jpg');
			r2c1.setAttribute ('src','../img/imageCasino/pear.jpg');
			r3c1.setAttribute ('src','../img/imageCasino/apple.jpg');
		}
	}
	if(i==1){
		if(lastFruit==fruitNow){flag=true;}
		if(fruitImg==0){
			r1c2.setAttribute ('src','../img/imageCasino/apple.jpg');
			r2c2.setAttribute ('src','../img/imageCasino/lemon.jpg');
			r3c2.setAttribute ('src','../img/imageCasino/pear.jpg');
		}
		if(fruitImg==1){
			r1c2.setAttribute ('src','../img/imageCasino/pear.jpg');
			r2c2.setAttribute ('src','../img/imageCasino/apple.jpg');
			r3c2.setAttribute ('src','../img/imageCasino/lemon.jpg');
		}
		if(fruitImg==2){
			r1c2.setAttribute ('src','../img/imageCasino/lemon.jpg');
			r2c2.setAttribute ('src','../img/imageCasino/pear.jpg');
			r3c2.setAttribute ('src','../img/imageCasino/apple.jpg');
		}
	}
	if(i==2){
		if((lastFruit==fruitNow)&&(flag==true)){}
		...
		if(fruitImg==0){
			r1c3.setAttribute ('src','../img/imageCasino/apple.jpg');
			r2c3.setAttribute ('src','../img/imageCasino/lemon.jpg');
			r3c3.setAttribute ('src','../img/imageCasino/pear.jpg');
		}
		if(fruitImg==1){
			r1c3.setAttribute ('src','../img/imageCasino/pear.jpg');
			r2c3.setAttribute ('src','../img/imageCasino/apple.jpg');
			r3c3.setAttribute ('src','../img/imageCasino/lemon.jpg');
		}
		if(fruitImg==2){
			r1c3.setAttribute ('src','../img/imageCasino/lemon.jpg');
			r2c3.setAttribute ('src','../img/imageCasino/pear.jpg');
			r3c3.setAttribute ('src','../img/imageCasino/apple.jpg');
		}
	}
}
