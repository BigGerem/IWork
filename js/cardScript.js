...
if (wWidth >= 480) {
	...
	content.setAttribute('style', 'display: flex; width: 50%; margin: 0 auto; align-items: center; justify-content: space-between; height: 85%;');
	userField.setAttribute('style', 'width: 33%; display: flex; align-items: center; flex-direction: column; margin: 0; height:440px;');
	divOptions.setAttribute('style', 'width: 33%; display: flex; align-items: center; flex-direction: column; margin: 0; height: 440px;');
	computerField.setAttribute('style', 'width: 33%; display: flex; align-items: center; flex-direction: column; margin: 0; height: 440px;');
...
let section = document.querySelector('#aCards');
...
function NewGame(){
	...
	userCard.setAttribute ('src','../img/imageCards/zero.png');
	computerCard.setAttribute ('src','../img/imageCards/zero.png');
	userCardPoint=0;
	computerCardPoint=0;
}
function CardDefinition(cardPointNow, card){
	if(card==0){
		if(cardPointNow==2){
			userCard.setAttribute ('src','../img/imageCards/user2valet.png');
		}
		if(cardPointNow==3){
			userCard.setAttribute ('src','../img/imageCards/user3dama.png');
		}
		if(cardPointNow==4){
			userCard.setAttribute ('src','../img/imageCards/user4korol.png');
		}
		if(cardPointNow==6){
			userCard.setAttribute ('src','../img/imageCards/user6.png');
		}
		if(cardPointNow==7){
			userCard.setAttribute ('src','../img/imageCards/user7.png');
		}
		if(cardPointNow==8){
			userCard.setAttribute ('src','../img/imageCards/user8.png');
		}
		if(cardPointNow==9){
			userCard.setAttribute ('src','../img/imageCards/user9.png');
		}
		if(cardPointNow==10){
			userCard.setAttribute ('src','../img/imageCards/user10.png');
		}
		if(cardPointNow==11){
			userCard.setAttribute ('src','../img/imageCards/user11tuth.png');
		}
	}
	else{
		if(cardPointNow==2){
			computerCard.setAttribute ('src','../img/imageCards/computer2valet.png');
		}
		if(cardPointNow==3){
			computerCard.setAttribute ('src','../img/imageCards/computer3dama.png');
		}
		if(cardPointNow==4){
			computerCard.setAttribute ('src','../img/imageCards/computer4korol.png');
		}
		if(cardPointNow==6){
			computerCard.setAttribute ('src','../img/imageCards/computer6.png');
		}
		if(cardPointNow==7){
			computerCard.setAttribute ('src','../img/imageCards/computer7.png');
		}
		if(cardPointNow==8){
			computerCard.setAttribute ('src','../img/imageCards/computer8.png');
		}
		if(cardPointNow==9){
			computerCard.setAttribute ('src','../img/imageCards/computer9.png');
		}
		if(cardPointNow==10){
			computerCard.setAttribute ('src','../img/imageCards/computer10.png');
		}
		if(cardPointNow==11){
			computerCard.setAttribute ('src','../img/imageCards/computer11tuth.png');
		}
	}
}